...
class TransformStampedList {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TransformStampedList(null);
  ...
  static datatype() {
    ...
    return 'meam520_labs/TransformStampedList';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TransformStampedList(null);
...
module.exports = TransformStampedList;
