...
if __name__ == "__main__":
    ...
    # print("alter_start_cfg_1=",alter_start_cfg_1)
    ...
    # print("alter_start_cfg_2=",alter_start_cfg_2)

    start_T0e[0][3] += 0.1
    start_T0e[1][3] += 0.1
    alter_start_position_3 = start_T0e 
    alter_start_cfg_3, _, _, _ = ik.inverse(alter_start_position_3, seed, method='J_trans', alpha=0.5)
    # alter_start_cfg_3 = np.array([ 0.40090751,  0.30846579,  0.07234462, -1.02254778, -0.02259408, 1.33062786, 1.24986364])
    print("alter position 3: ", alter_start_cfg_3)
    alter_start_cfg_list.append(alter_start_cfg_3)
    # print("alter_start_cfg_3=",alter_start_cfg_3)

    start_T0e[1][3] -= 0.2
    alter_start_position_4 = start_T0e
    alter_start_cfg_4, _, _, _ = ik.inverse(alter_start_position_4, seed, method='J_trans', alpha=0.5)
    # alter_start_cfg_4 = np.array([ 0.08765688,  0.06759924,  0.04025856, -1.35341197, -0.00274994, 1.42091676, 0.91281151])
    print("alter position 4: ", alter_start_cfg_4)
    alter_start_cfg_list.append(alter_start_cfg_4)
    # print("alter_start_cfg_4=",alter_start_cfg_4) 
    ...
    for i in range(4):
        ...
        H_rotate_10_y = np.array([[0.940,  0,  0.342,  0],
                               [ 0, 1,  0,  0],
                               [ -0.342,  0,  0.940,  0],
                               [ 0,  0,  0,  1]])
        ...
        if team == "red":
            ...
            pos_to_wait_dynamic =  H_rotate_10_y @ H_rotate_270_y @ start_T0e
